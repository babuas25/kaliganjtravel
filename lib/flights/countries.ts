/**
 * Every country the traveller form offers, as ISO-3166 alpha-2 plus dialing
 * code. Client-safe: plain data, no server imports.
 *
 * Ported from the tripfeels dataset so both products name and dial the same
 * places. Flag artwork is not stored here — the pickers render it from the
 * ISO code, so there is one fewer field to keep in sync.
 */

export type Country = {
  /** ISO-3166 alpha-2, which is what the supplier's Booking call wants. */
  code: string;
  name: string;
  /** Dialing code with its leading plus. Empty where a territory has none. */
  dialCode: string;
};
...
export const COUNTRIES: readonly Country[] = [
  ...
  { code: 'AS', name: "American Samoa", dialCode: '+684' },
  ...
  { code: 'BS', name: "Bahamas", dialCode: '+242' },
  { code: 'BH', name: "Bahrain", dialCode: '+973' },
  { code: 'BD', name: "Bangladesh", dialCode: '+880' },
  { code: 'BB', name: "Barbados", dialCode: '+246' },
  { code: 'BY', name: "Belarus", dialCode: '+375' },
  { code: 'BE', name: "Belgium", dialCode: '+32' },
  { code: 'BZ', name: "Belize", dialCode: '+501' },
  { code: 'BJ', name: "Benin", dialCode: '+229' },
  { code: 'BM', name: "Bermuda", dialCode: '+441' },
  ...
  { code: 'VG', name: "British Virgin Islands", dialCode: '+284' },
  ...
  { code: 'DO', name: "Dominican Republic", dialCode: '+809' },
  ...
  { code: 'GD', name: "Grenada", dialCode: '+473' },
  { code: 'GP', name: "Guadeloupe", dialCode: '+590' },
  { code: 'GU', name: "Guam", dialCode: '+671' },
  ...
  { code: 'JM', name: "Jamaica", dialCode: '+876' },
  ...
  { code: 'MS', name: "Montserrat", dialCode: '+664' },
  ...
  { code: 'MP', name: "Northern Mariana Islands", dialCode: '+670' },
  ...
  { code: 'PR', name: "Puerto Rico", dialCode: '+787' },
  ...
  { code: 'SJ', name: "Svalbard", dialCode: '+47' },
  ...
  { code: 'TT', name: "Trinidad and Tobago", dialCode: '+868' },
  { code: 'TN', name: "Tunisia", dialCode: '+216' },
  { code: 'TR', name: "Turkey", dialCode: '+90' },
  { code: 'TM', name: "Turkmenistan", dialCode: '+993' },
  { code: 'TC', name: "Turks and Caicos Islands", dialCode: '+649' },
  ...
  { code: 'VI', name: "U.S. Virgin Islands", dialCode: '+340' },
...
/** Only those that can actually be dialled, for the phone-code picker. */
export const PHONE_COUNTRIES: readonly Country[] = COUNTRIES.filter(
  (country) => country.dialCode.length > 0
);

/** `"BD"` becomes `"Bangladesh"`, falling back to the code itself. */
